...
if st.sidebar.toggle("🧪 Dev: open with chest pain sample", key="toggle2", on_change=makenill(answers)):
    test = """{
...
if st.sidebar.toggle("🧪 Dev: open with abdominal pain sample", key="toggle1", on_change=makenill(answers)):
